...
class TestCommandStation(unittest.TestCase):
    ...
    def test_str(self):
        string_output = str(self.command_station_instance)
        self.assertEqual(string_output, "Welcome to the {}".format(self.command_station_instance.name))

    def test_repr(self):
        repr_output = repr(self.command_station_instance)
